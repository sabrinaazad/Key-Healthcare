...
?>
<section class="section section--side-by-side full-width <?php echo $reverse ?>" style="background-color:<?php echo the_sub_field("background_color"); ?>" id="<?php echo the_sub_field('id')?>">
